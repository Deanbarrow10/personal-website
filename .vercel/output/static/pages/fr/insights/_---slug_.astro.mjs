/* empty css                                       */
import { c as createAstro, a as createComponent, r as renderTemplate, d as renderComponent, e as renderScript, m as maybeRenderHead } from '../../../chunks/astro/server_B8C3cij_.mjs';
import 'kleur/colors';
...
Table of Contents:
</p> <div id="toc" class=""> <ul class="space-y-2 text-pretty text-base text-neutral-700 transition duration-300 dark:text-neutral-400"></ul> </div> </div> </div> <div class="md:pt-8"> <h1 class="mb-4 text-balance text-center text-2xl font-bold text-neutral-800 dark:text-neutral-200 sm:text-3xl md:mb-6 md:text-left"> ${post.data.title} </h1> <article class="text-pretty text-lg text-neutral-700 dark:text-neutral-300"> ${renderComponent($$result2, "Content", Content, {})} </article> </div> </div> </div> </section> ` })}  ${renderScript($$result, "/Users/deanbarrow/Projects/personal-website/src/pages/fr/insights/[...slug].astro?astro&type=script&index=0&lang.ts")} ${renderScript($$result, "/Users/deanbarrow/Projects/personal-website/src/pages/fr/insights/[...slug].astro?astro&type=script&index=1&lang.ts")}`;
}, "/Users/deanbarrow/Projects/personal-website/src/pages/fr/insights/[...slug].astro", void 0);

const $$file = "/Users/deanbarrow/Projects/personal-website/src/pages/fr/insights/[...slug].astro";
