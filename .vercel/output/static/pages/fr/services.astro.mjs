...
const blueprints = new Proxy({"src":"/_astro/blueprints-image.DxAt2gto.avif","width":1333,"height":2000,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/deanbarrow/Projects/personal-website/src/images/blueprints-image.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/deanbarrow/Projects/personal-website/src/images/blueprints-image.avif");
							return target[name];
						}
					});
...
const personWorking = new Proxy({"src":"/_astro/person-working.aUGgRiE_.avif","width":1334,"height":2000,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/deanbarrow/Projects/personal-website/src/images/person-working.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/deanbarrow/Projects/personal-website/src/images/person-working.avif");
							return target[name];
						}
					});
...
const beforeAfter = new Proxy({"src":"/_astro/before-after.BntBToq6.avif","width":2048,"height":1366,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/deanbarrow/Projects/personal-website/src/images/before-after.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/deanbarrow/Projects/personal-website/src/images/before-after.avif");
							return target[name];
						}
					});
...
const constructionWorkers = new Proxy({"src":"/_astro/construction-workers.XhU7Ouf4.avif","width":1920,"height":1280,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/deanbarrow/Projects/personal-website/src/images/construction-workers.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/deanbarrow/Projects/personal-website/src/images/construction-workers.avif");
							return target[name];
						}
					});
...
const aerialView = new Proxy({"src":"/_astro/aerial-view.CeV30CXX.avif","width":1920,"height":1282,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/deanbarrow/Projects/personal-website/src/images/aerial-view.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/deanbarrow/Projects/personal-website/src/images/aerial-view.avif");
							return target[name];
						}
					});
...
const usingTools = new Proxy({"src":"/_astro/using-tools.BrEE8t5H.avif","width":1920,"height":1280,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/deanbarrow/Projects/personal-website/src/images/using-tools.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/deanbarrow/Projects/personal-website/src/images/using-tools.avif");
							return target[name];
						}
					});
...
const progressBuilding = new Proxy({"src":"/_astro/progress-building.Cjca0suI.avif","width":1920,"height":2560,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/deanbarrow/Projects/personal-website/src/images/progress-building.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/deanbarrow/Projects/personal-website/src/images/progress-building.avif");
							return target[name];
						}
					});
...
const underConstruction = new Proxy({"src":"/_astro/under-construction.DfISh1yq.avif","width":1920,"height":2876,"format":"avif"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/deanbarrow/Projects/personal-website/src/images/under-construction.avif";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/deanbarrow/Projects/personal-website/src/images/under-construction.avif");
							return target[name];
						}
					});
...
}, "/Users/deanbarrow/Projects/personal-website/src/pages/fr/services.astro", void 0);

const $$file = "/Users/deanbarrow/Projects/personal-website/src/pages/fr/services.astro";
